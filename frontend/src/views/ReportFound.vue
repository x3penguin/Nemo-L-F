        ...
        <div class="report-card">
          ...
          <div class="form-content">
            ...
            <div v-if="currentStep === 1" class="form-step">
              ...
              <p class="step-description">Please provide details about the item you've found.</p>
            ...
            <div v-if="currentStep === 2" class="form-step">
              ...
              <div class="form-group">
                ...
                >
                <div v-if="errors.foundDate" class="error-message">{{ errors.foundDate }}</div>
              </div>
              ...
              <div class="form-group">
                ...
                >
                  ...
                  <option value="lost_found_office">At lost & found office</option>
                  <option value="other">Other</option>
                </select>
                <div v-if="errors.currentLocation" class="error-message">{{ errors.currentLocation }}</div>
              </div>
              ...
              <div v-if="formData.currentLocation === 'other'" class="form-group">
                ...
                >
                <div v-if="errors.otherLocationDetails" class="error-message">{{ errors.otherLocationDetails }}</div>
              </div>
            </div>
            ...
            <div v-if="currentStep === 3" class="form-step">
              ...
              <p class="step-description">Adding clear images will significantly improve matching with lost items.</p>
              ...
              <div class="confirmation-summary">
                ...
                <div class="summary-section">
                  ...
                  <div class="summary-item">
                    ...
                    <span class="summary-value">{{ formatDate(formData.foundDate) }}</span>
                  </div>
    ...
    setup() {
      ...
      const validateStep = () => {
        ...
        if (currentStep.value === 1) {
          ...
          if (formData.value.currentLocation === 'other' && !formData.value.otherLocationDetails) {
            errors.value.otherLocationDetails = 'Please specify the current location';
          }
        }
      ...
      const submitForm = async () => {
        ...
        try {
          ...
          if (formData.value.currentLocation === 'other') {
            apiFormData.append('other_location_details', formData.value.otherLocationDetails);
          }
